            ...
            <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="d-flex align-items-center st1border " >
                      <router-link :to="{ name: 'trangchu' }" class="navbar-brand logo">
                        <img src="@/assets/logo.jpg" alt="Shop" width="80" height="80">
                        
                      </router-link>
                    
                        <h2 class="font-weight-semi-bold shoptext">SHOP</h2>    
                    </div>
                </div>
                </div>
                <!-- banner + dieu huong -->
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                              <div class="carousel-item active" id="anhbanner">
                                <img src="@/assets/logo3.jpg" class="d-block w-100" alt="carousel-1">
                                <div class="text">
                                    <p>SHOP</p>
                                    <h2>Thương hiệu hàng đầu trong lĩnh vực nội thất</h2>
                                </div>
                              </div>
                              <div class="carousel-item" id="anhbanner">
                                <img src="@/assets/logo2.jpg" class="d-block w-100" alt="carousel-2">
                                <div class="text">
                                    <p>Ưu đãi</p>
                                    <h2>Nhiều ưu đãi khuyến mãi lớn</h2>
                                </div>
                              </div>
                              <div class="carousel-item" id="anhbanner">
                                <img src="@/assets/logo3.jpg" class="d-block w-100" alt="carousel-3">
                                <div class="text">
                                    <p>Thương Hiệu Hàng Đầu</p>
                                    <h2>Giao hàng nhanh chóng, tận nơi</h2>
                                </div> 
                            </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mt-3">
                    <div class="d-flex align-items-center st1border" >
                        ...
                        <h5 class="font-weight-semi-bold "> Giao hàng tận nơi</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 mt-3">
                    <div class="d-flex align-items-center st1border " >
        ...
        <div class="container st2">
            <div class="row" >
                <!--     load du lieu san pham      -->
                    <div class="col-lg-3 col-md-6 mt-3 mb-5" v-for="(sanpham) in this.listsanpham.slice(0,this.listsanpham.length)" :key="sanpham.idloai">
                      <div class="card" style="width: 16rem; ">
                      <iframe v-if="sanpham.linkanh" :src="sanpham.linkanh" class="card-img-top" alt="SanPham" id="anhsp"></iframe>
                      <div class="card-body">
...
import loaihangService from "../services/genres.service";
