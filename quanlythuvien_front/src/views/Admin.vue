            ...
            <div class="row st1">
              <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="d-flex align-items-center st1border " >
                      ...
                      <h2 class="font-weight-semi-bold ">SHOP</h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 mt-3 tien">
                    <div class="d-flex align-items-center st1border" >
                        <h2 class="fa-solid fa-money-check-dollar"></h2>
                        <h5 class="font-weight-semi-bold ">Tổng Doanh Thu <br/>{{formattedGia(this.doanhthu.tongdoanhthu)}}</h5>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mt-3 tien">
                    <div class="d-flex align-items-center st1border" >
                        <h2 class="fa-solid fa-money-check-dollar"></h2>
                        <h5 class="font-weight-semi-bold ">Doanh Thu Trong Tháng <br/>{{formattedGia(this.doanhthu.tongdoanhthutrongthang)}}</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 mt-3 tien">
                    <div class="d-flex align-items-center st1border" >
                        <h2 class="fa-solid fa-money-check-dollar"></h2>
                        <h5 class="font-weight-semi-bold ">Doanh Thu Trong Ngày <br/> {{formattedGia(this.doanhthu.tongdoanhthutrongngay)}}</h5>
                    </div>
                </div>
            </div>
        </section> -->
