<template>
    <Form class="row form-capnhat"  
      ...
      <div class="row mb-3 mt-3 form-group" >
          <label for="ngaysinh" class="form-label col-sm-3 nhaninput" >Ngaysinh<span class="error">*:</span></label>
          <div class="col-9">
              <Field
                  name="ngaysinh"
                  type="date"
                  class="form-control "
                  v-model="nguoidungLocal.ngaysinh" 
              />
    ...
    <div class="row mt-2 mb-5">
        <div class="form-group col-6 offset-7">
            ...
            <button v-if="mode=='edit'"  type="button" class="m-2 btn btn-danger" @click="deletenguoidung">Xóa</button> 
        </div>
    </div> 
  </Form>
</template>
